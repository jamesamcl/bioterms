...
export namespace Predicates {
    ...
    export namespace SBOL3 {
        ...
        export const location:string = Prefixes.sbol3 + 'location'
        export const start:string = Prefixes.sbol3 + 'start'
        ...
        export const id:string = Prefixes.sbol3 + 'id'
        ...
        export const remote:string = Prefixes.sbol3 + 'remote'
        ...
        export const encoding:string = Prefixes.sbol3 + 'encoding'
        export const elements:string = Prefixes.sbol3 + 'elements'
        export const persistentIdentity:string = Prefixes.sbol3 + 'persistentIdentity'
        export const restriction:string = Prefixes.sbol3 + 'restriction'
        export const subject:string = Prefixes.sbol3 + 'subject'
        export const object:string = Prefixes.sbol3 + 'object'
        export const member:string = Prefixes.sbol3 + 'member'
        export const model:string = Prefixes.sbol3 + 'model'
        export const framework:string = Prefixes.sbol3 + 'framework'
        export const language:string = Prefixes.sbol3 + 'language'
        export const source:string = Prefixes.sbol3 + 'source'
        export const attachment:string = Prefixes.sbol3 + 'attachment'
        export const format:string = Prefixes.sbol3 + 'format'
        export const size:string = Prefixes.sbol3 + 'size'
        export const hash:string = Prefixes.sbol3 + 'hash'
        export const built:string = Prefixes.sbol3 + 'built'
        ...
        export const measure:string = Prefixes.sbol3 + 'measure'
    }
